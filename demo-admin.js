...
(function () {
    ...
    // 完全に独立したデモ用データプレフィックス
    const PRE = 'demo_';
    const LS = {
        shopInfo: PRE+'br_shopInfo', menus: PRE+'br_menus', settings: PRE+'br_settings',
        reservations: PRE+'br_reservations', notificationQueue: PRE+'br_notificationQueue',
        staffs: PRE+'br_staffs', customerNotes: PRE+'br_customerNotes'
    };
